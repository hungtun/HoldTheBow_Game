...
public class AuthenticationService : IAuthenticationService
{
    ...
    public AuthenticationService(Settings settings, GameDbContext context, ILogger<AuthenticationService> logger)
    {
        _settings = settings;
        _context = context;
        _logger = logger;
    ...
    public (bool success, string content) Logout(int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in LogoutAsync method");
